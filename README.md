...
4. Clienti derlemek için: java -cp ".;com/google/protobuf/protobuf-java-4.28.3.jar" Client.java (client'ı çalıştırırken Java server'ları çalışır durumda olmalıdır!) 
